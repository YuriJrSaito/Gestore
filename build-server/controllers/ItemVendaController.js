...
var ItemVenda = require('../models/ItemVenda');
var ProdutoController = require('./ProdutoController');
var ItemVendaController = /*#__PURE__*/function () {
  function ItemVendaController() {
    _classCallCheck(this, ItemVendaController);
  }
  _createClass(ItemVendaController, [{
    key: "gravar",
    value: function () {
      var _gravar = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response) {
        var _request$body, produtos, idVenda, resp, msg, x, qtde, valor, itemVenda;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                _context.next = 9;
                return ProdutoController.atualizarQtdeVendido(bd, produtos[x].id, produtos[x].qtdeSelecionado);
              case 9:
                ...
                itemVenda = new ItemVenda(0, produtos[x].qtdeSelecionado, valor, idVenda, produtos[x].id);
                _context.next = 15;
                return itemVenda.gravar(bd);
              case 15:
                x++;
                _context.next = 3;
                break;
              case 18:
                if (resp != false) msg += "Venda cadastrada com sucesso";else msg += "Algo deu errado";
    ...
    key: "buscarProduto",
    value: function () {
      var _buscarProduto = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(request, response) {
        var idProduto, itemVenda, resp;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return itemVenda.buscarProduto(bd, idProduto);
              case 4:
                resp = _context4.sent;
      ...
      function buscarProduto(_x7, _x8) {
