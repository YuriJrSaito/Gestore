...
module.exports = /*#__PURE__*/function () {
  function ContaReceberDAO() {
    _classCallCheck(this, ContaReceberDAO);
  }
  _createClass(ContaReceberDAO, [{
    key: "gravar",
    value: function () {
      var _gravar = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(bd, contaReceber) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                sql = "INSERT INTO contareceber VALUES (default, $1, $2, $3, $4) RETURNING *";
                values = Object.values(contaReceber).slice(1); //retira o id
                _context.prev = 5;
                _context.next = 8;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.prev = 3;
                _context2.next = 6;
                return client.query('SELECT * from contareceber');
              case 6:
                res = _context2.sent;
    ...
    key: "buscarConta",
    value: function () {
      var _buscarConta = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(bd, idConta) {
        var client, res;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.prev = 3;
                _context3.next = 6;
                return client.query('SELECT * from contareceber WHERE id =' + idConta);
              case 6:
                res = _context3.sent;
    ...
    key: "deletar",
    value: function () {
      var _deletar = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(bd, idConta) {
        var client, sql;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                sql = "DELETE FROM contareceber WHERE id = " + idConta;
                _context4.prev = 4;
                _context4.next = 7;
